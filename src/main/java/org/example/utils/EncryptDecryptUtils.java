...
public class EncryptDecryptUtils {
    ...
    private static final String SECRET_KEY_1 = "Alexd$HUy2A#D%kd"; // "ssdkF$HUy2A#D%kd"
    private static final String SECRET_KEY_2 = "AlexSEvR5yAC5ftB"; // "weJiSEvR5yAC5ftB"
    ...
    public static void main(String[] args) throws NoSuchPaddingException, UnsupportedEncodingException, NoSuchAlgorithmException,
        ...
        System.out.println(cryptUtils.decrypt("/j/CD5RnMO6iekyDMLBe2A=="));
